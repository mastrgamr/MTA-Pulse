...
public class StikkyHeaderGridView extends StikkyHeader {

    private final HeaderGridView mHGridView;
    private AbsListView.OnScrollListener mDelegateOnScrollListener;

    public StikkyHeaderGridView(final Context context, final HeaderGridView hGridView, final View header, final int mMinHeightHeader, final HeaderAnimator headerAnimator) {

        this.mContext = context;
        this.mHGridView = hGridView;
        this.mHeader = header;
    ...
    private class StickyOnScrollListener implements AbsListView.OnScrollListener {
        ...
        private int calculateScrollYList() {
            View c = mHGridView.getChildAt(0);
            if (c == null) {
                return 0;
            }
            ...
            int firstVisiblePosition = mHGridView.getFirstVisiblePosition();
            int top = c.getTop();
